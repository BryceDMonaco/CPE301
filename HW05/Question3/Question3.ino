...
void loop() 
{
  //T of 12 kHz wave = 1/12000 = 8.33333333e-5 s -> 0.0833333333 ms
  
  *portB |= 0x40;
  
  *thisTCCR1B &= 0xF8;              //Disable Timer
  *thisTCNT1 = (unsigned int) (65536 - (long) (15.625 * 0.0833333333)); //The timer will count up from the value to the max 65536
