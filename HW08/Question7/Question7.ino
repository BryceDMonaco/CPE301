...
/*
 * Note number of ticks (31250) was found with the following equation:
 *          ((1/x)/(6.25*10^-8))
 * Where x is the frequncy (in this case 8) and 6.25*10^-8 is the period of the CPU (1/16 MHz).
 * This gave 2,000,000 ticks at PS1 which is far too much so the clock is run at PS64 making
 * the amount of ticks required only 31,250
 * 
 */
...
void InitializeTimer ()
{
  ...
  *thisTCNT1 = (unsigned int) (65536 - 31250); //The timer will count up from the value to the max 65536
  *thisTCCR1B |= 0b00000011; //Run the timer at PS64
